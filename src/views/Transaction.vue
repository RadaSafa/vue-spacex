...
<formUpdate :data="transactions" :dialog="formUp" @close="formUp=false"/>
<formDelete :data="transactions" :dialogDel="formDel" @close="formDel=false"/>
    ...
    methods:{
      ...
      showDialog(data){
        ...
        console.log(this.transactions);
         ...
         this.productKeyEdit= transactions.merchantkey,
         this.productCodeEdit=transactions.merchantcode,
         this.productIdEdit= transactions.transid,
         this.productAmountEdit=transactions.amount,
         this.productCurrencyEdit=transactions.currency,
         this.productIdEdit=transactions._id,
         this.productDate=transactions.date_added,
        this.productV=transactions.__v
